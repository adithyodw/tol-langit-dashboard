...
export const BASE = [
  {
    ...
    monthlyData: [
      { month: 'Jun 2024', growth: '+3.82%', balance: 84920.0 },
      { month: 'Jul 2024', growth: '+5.47%', balance: 89550.0 },
      { month: 'Aug 2024', growth: '+2.91%', balance: 92158.0 },
      { month: 'Sep 2024', growth: '+4.65%', balance: 96438.0 },
      { month: 'Oct 2024', growth: '+3.28%', balance: 99602.0 },
      { month: 'Nov 2024', growth: '+6.15%', balance: 105735.0 },
      { month: 'Dec 2024', growth: '+4.29%', balance: 110265.0 },
      { month: 'Jan 2025', growth: '+5.12%', balance: 115927.0 },
      { month: 'Feb 2025', growth: '+3.78%', balance: 120289.0 },
      { month: 'Mar 2025', growth: '+4.34%', balance: 125508.0 },
      { month: 'Apr 2025', growth: '+2.67%', balance: 128853.0 },
      { month: 'May 2025', growth: '+5.89%', balance: 136433.0 },
    ],
  },
  {
    id: 'etfgold',
